...
rename_lookup_lfpse<-c(
  ...
  "Occurred Date" = "occurred_date", #required # changed from T005- Event Date, should it go back?
  ...
  # "Occurred Year" = "year(OccurredDate)", # changed from T005 - Event Year
  # "Occurred Month" = "month(OccurredDate)", # changed from T005 - Event Year
  ...
  "CL001 - Event Type" = "CL001_Type", # alternative is CL001_Event, is CL001_Type correct?
  ...
  # "OT008 - Outcome Type" = "OT008", # MISSING
